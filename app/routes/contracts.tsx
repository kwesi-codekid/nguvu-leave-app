...
export default function StaffContracts() {
    ...
    const [selectedContract, setSelectedContract] =
        useState<StaffContractInterface | null>(null)
        ...
        const exportColumns = [
            {
                key: "staff.name",
                label: "Staff Name",
                formatter: formatters.staffName,
            },
            ...
            { key: "jobPosition.title", label: "Job Position" },
            {
                key: "department.name",
                label: "Department",
                formatter: formatters.department,
            },
            {
                key: "startDate",
                label: "Start Date",
        ...
        >
            <div className='flex flex-col gap-8 pb-8'>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex items-center gap-2'>
                        <Select
                            ...
                            onSelectionChange={(keys) =>
                                setSelectedExportFormat(
                                    Array.from(keys)[0] as ExportFormat,
                                )
                            }
                        >
                        ...
                        <Button
                            ...
                            isDisabled={
                                isLoading || !data?.data?.contracts?.length
                            }
                        >
                            Export
                        </Button>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <MobileList
                        isLoading={isLoading}
                        listContent={data?.data?.contracts?.map(
                            (contract: any) => ({
                                startIcon: (
                                    <Handshake className='size-4 text-warning' />
                                ),
                    ...
                    {(onClose) => (
                        <>
                            ...
                            <ModalBody>
                                ...
                                <p className='text-xs text-zinc-500'>
                                    This action cannot be undone. The staff
                                    member will no longer be associated with
                                    this position.
                                </p>
                            </ModalBody>
                            <ModalFooter>
                        ...
                        <>
                            ...
                            <ModalBody>
                                ...
                                <p className='text-xs text-zinc-500 mb-2'>
                                    This will end the contract and set the staff
                                    member's status to inactive. The contract
                                    record will be kept for audit purposes.
                                </p>
                                <Input
                            ...
                            <ModalFooter>
                                ...
                                <Button
                                    color='danger'
                                    onPress={() =>
                                        handleConfirmTerminate(onClose)
                                    }
